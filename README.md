...
This is a quick start template for [Hugo theme Stack](https://github.com/ifindv/hugo-theme-stack). It uses [Hugo modules](https://gohugo.io/hugo-modules/) feature to load the theme.
...
```bash
hugo mod get -u github.com/ifindv/hugo-theme-stack/v3
hugo mod tidy
```
