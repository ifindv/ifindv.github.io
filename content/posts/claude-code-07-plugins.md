---
title: "claude code 教程：plugins"
description: "claude code 插件详解"
date: 2026-04-28
categories: ["AI"]
tags: ["claude code"]
featured: true
author: "ifindv"
---
插件是整合了command、subagent、MCP、hooks的高阶扩展机制。
...
插件是将多个claude code功能捆绑成连贯、可安装的包。它们代表最高级别的扩展机制，结合了多个功能，如命令、子代理、MCP服务和钩子。
